  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-5 ml-auto">
        <h3 class="mb-4 nanumsquare" align="center"><b>기부해주신 금액을 </br>소중히 사용하겠습니다.</b></h3>
        </br>
        <b><p>기부 모금함 : ${donation.name} </p>
        <p>기부 단체 : ${donation.orgnName} </p>
        <p>기부 금액 : ${donateMoney} 원 </p></b>
        </br>
        <p><a href="detail?no=${donation.no}" class="btn btn-primary rounded-0 px-4">모금함으로 돌아가기</a>&nbsp;
        <a href="#" class="btn btn-primary rounded-0 px-4">기부내역</a></p>
        </div>
      </div>
    </div>
  </div>
