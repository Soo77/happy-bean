        ...
        <section class="signup">
            ...
            <div class="auth-container">
                <div class="signup-content">
                    <form action='../member/add' name="userInfo" method="POST" id="signup-form" class="signup-form" enctype='multipart/form-data' onsubmit='return checkValue()'>
                        <div class="form-title" style="font-family: Nanum; font-size: 30px;">회원가입</div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="id" id="id" placeholder="아이디" onkeydown="inputIdChk()" required="" autofocus=""/>
