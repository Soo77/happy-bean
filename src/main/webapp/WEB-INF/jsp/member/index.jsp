...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/jquery.fancybox.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/fonts/flaticon-1/font/flaticon.css">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <script src="<c:url value="/js/popper.min.js" />">

    <!-- <script src="js/bootstrap.min.js"></script> -->
    <script src="<c:url value="/js/bootstrap.min.js" />">

    <!-- <script src="js/owl.carousel.min.js"></script> -->
    <script src="<c:url value="/js/owl.carousel.min.js" />">

    <!-- <script src="js/jquery.sticky.js"></script> -->
    <script src="<c:url value="/js/jquery.sticky.js" />">

    <!-- <script src="js/jquery.waypoints.min.js"></script> -->
    <script src="<c:url value="/js/jquery.waypoints.min.js" />">

    <!-- <script src="js/jquery.animateNumber.min.js"></script> -->
    <script src="<c:url value="/js/jquery.animateNumber.min.js" />">

    <!-- <script src="js/jquery.fancybox.min.js"></script> -->
    <script src="<c:url value="/js/jquery.fancybox.min.js" />">

    <!-- <script src="js/jquery.easing.1.3.js"></script> -->
    <script src="<c:url value="/js/jquery.easing.1.3.js" />">

    <!-- <script src="js/aos.js"></script> -->
    <script src="<c:url value="/js/aos.js" />">
